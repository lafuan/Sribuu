...
**Latest Run:** 2026-07-09 14:00 WIB — ❌ Deploy pipeline STILL 100% BLOCKED (49/50 failures, 75h+ stale). Root cause: missing `migrations/0003_add_payment_column.sql`. Created #665 (esbuild vulnerability). Escalated on #638 with cumulative stats.
